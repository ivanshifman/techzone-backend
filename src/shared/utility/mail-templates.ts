export const mailTemplates = {
  ...
  forgotPassword: (
    ...
    `,
  webhook: (customerEmail: string, orderId: string) => `
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
        ...
        <style>
            ...
            .email-body p { margin: 15px 0; line-height: 1.5; }
            .order-id { font-weight: bold; color: #007bff; }
            .email-footer { background-color: #f4f4f9; text-align: center; padding: 15px; font-size: 12px; color: #888888; }
    ...
    <body>
        <div class="email-container">
            ...
            <div class="email-body">
                ...
                <p>Your digital licenses are now available for download. If you have any issues, please contact our support team.</p>
                <p>This email was sent to: <strong>${customerEmail}</strong></p>
            </div>
            <div class="email-footer">
                <p>If you need help, reach out to <a href="mailto:support@example.com">support@example.com</a>.</p>
                <p>&copy; 2025 Your Company Name. All rights reserved.</p>
            </div>
        </div>
    </body>
